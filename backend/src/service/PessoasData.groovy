...
class PessoasData {
    ...
    List<PessoaFisica> candidatos = [
            ...
            new PessoaFisica(nome: 'Kurosaki Ichigo', email: 'kurosaki.ichigo@email.com', estado: 'Soul Society', descricao: 'Arquiteto de Software', cep: '29010-456', cpf: '654.321.987-33', idade: 18, competencias: ['C#', 'Azure', 'Bankai'])
    ]

    public void addCandidato(PessoaFisica pessoa){
        candidatos.add(pessoa);
    }

    public void addEmpresa(PessoaJuridica empresa){
